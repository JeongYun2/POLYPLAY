...
<div class="swiper-container main-slider" id="myCarousel">
  <div class="swiper-wrapper">
    <div class="swiper-slide slider-bg-position" style="background:url('resources/image/test1.jpg')" data-hash="slide1">
      <h2>폴리플레이가 추천하는 영화</h2>
    </div>
    <div class="swiper-slide slider-bg-position" style="background:url('resources/image/test2.png')" data-hash="slide2">
      <h2>이런 영화는 어떠신가요?</h2>
    </div>
    <div class="swiper-slide slider-bg-position" style="background:url('resources/image/test4.jpg')" data-hash="slide3">
      <h2>밤하늘</h2>
    </div>
  </div>
  <!-- Add Pagination -->
...
<section class="service-sec" id="benefits">
  <div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="heading text-md-center text-xs-center">
      <h2><small>요즘 뜨는 영화</small>지금 구매하세요</h2>
    </div>
        </div>
